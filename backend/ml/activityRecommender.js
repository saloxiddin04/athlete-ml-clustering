...
const REC_FEATURES = ["height_cm", "weight_kg", 'age', 'stress_level', 'sleep_hours', 'avg_heart_rate', 'endurance_level', "bmi", "hydration_level", "diastolic_bp", "systolic_bp", "resting_heart_rate", "daily_steps"];
